<template>
  <div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
    ...
    <div v-auth="'api:console:online-user:page:post'" class="layout-navbars-breadcrumb-user-icon mr10" @click="onOnlineUserClick">
			<el-icon title="在线用户">
				<ele-User />
			</el-icon>
		</div>
    <el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
      <span class="layout-navbars-breadcrumb-user-link">
        ...
        <span class="layout-navbars-breadcrumb-user-link-name">{{ userInfos.realName ? userInfos.realName : '' }}</span>
      ...
      <template #dropdown>
        <el-dropdown-menu>
          <el-dropdown-item command="/workspace/workbench">{{ $t('工作台') }}</el-dropdown-item>
          <el-dropdown-item command="/workspace/personal">{{ $t('message.user.dropdown2') }}</el-dropdown-item>
...
const OnlineUser = defineAsyncComponent(()=>import('/@/layout/navBars/topBar/onlineUser.vue'))
