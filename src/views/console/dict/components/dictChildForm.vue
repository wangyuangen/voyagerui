            ...
            <el-form ref="ruleFormRef" :model="state.form" size="default" label-width="80px">
                <el-row :gutter="35">
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="父级" prop="parentCode" :rules="[{ required: true, message: '请输入父级字典编码', trigger: ['blur', 'change'] }]">
                            <el-input v-model="state.form.parentCode" autocomplete="off" readonly/>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
...
<script lang="ts" setup name="console/dictChild/form">
