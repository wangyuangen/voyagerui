        ...
        <template v-if="data.logic && !data.field">
          <div class="my-flex">
            <el-radio-group v-model="data.logic">
              ...
              <el-radio label="Xor">异或</el-radio>
            </el-radio-group>
...
const operators = {
  equal: { label: '等于', value: 'EQ' },
  notEqual: { label: '不等于', value: 'NEQ' },
  contains: { label: '包含', value: 'Contains' },
  startsWith: { label: '开始以', value: 'StartsWith' },
  endsWith: { label: '结束以', value: 'EndsWith' },
  lessThan: { label: '小于', value: 'LT' },
  lessThanOrEqual: { label: '小于等于', value: 'LTE' },
  greaterThan: { label: '大于', value: 'GT' },
  greaterThanOrEqual: { label: '大于等于', value: 'GTE' },
}
